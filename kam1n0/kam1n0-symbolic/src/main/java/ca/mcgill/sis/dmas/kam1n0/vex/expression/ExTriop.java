...
public class ExTriop extends VexExpression {
	...
	public ExTriop(@JsonProperty("operation") VexOperation operation, @JsonProperty("exp1") VexExpression exp1,
			@JsonProperty("exp2") VexExpression exp2, @JsonProperty("exp3") VexExpression exp3) {
		this.operation = operation;
		this.exp1 = exp1;
		this.exp2 = exp2;
		this.exp3 = exp3;
		this.tag = VexExpressionType.Iex_Triop;
	}

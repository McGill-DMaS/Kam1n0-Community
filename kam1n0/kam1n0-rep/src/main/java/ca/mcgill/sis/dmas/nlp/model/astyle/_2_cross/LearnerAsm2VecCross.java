...
public class LearnerAsm2VecCross {

	private static Logger logger = LoggerFactory.getLogger(LearnerAsm2VecCross.class);

	public static class Asm2VecParam extends Param {
	...
	public LearnerAsm2VecCross(Asm2VecParam param) {
		this.param = param;
	}
}

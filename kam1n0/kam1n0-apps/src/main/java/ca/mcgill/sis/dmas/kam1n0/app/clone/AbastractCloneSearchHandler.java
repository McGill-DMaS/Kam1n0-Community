...
import ca.mcgill.sis.dmas.kam1n0.impl.disassembly.DisassemblyFactoryGhidraModel;
...
public abstract class AbastractCloneSearchHandler extends ApplicationHandler {
    ...
    Map<String, Object> postBinary(@PathVariable("appId") long appId,
            ...
            if (objs[i] instanceof MultipartFile) {
                ...
                try {
                    ...
                    try {
                        ...
                        surrogate = mapper.readValue(
                                (String)objs[i], DisassemblyFactoryGhidraModel.class).toBinarySurrogate().processRawBinarySurrogate();
                    } catch (Exception e_ghidra) {
                        e_ghidra.printStackTrace();
                        e.printStackTrace();
                        logger.error("Failed to process submited mutipart file", e);
    ...
    public @ResponseBody
    Map<String, Object> searchBinarySingle(@PathVariable("appId") long appId,
    ...
    @Access(AccessMode.READ)
    public @ResponseBody
    Map<String, Object> deleteTemp(@PathVariable("appId") long appId) {
        try {
            String tmpDir = getUserTmpDir(appId);
    ...
    @Access(AccessMode.READ)
    public @ResponseBody
    Map<String, Object> searchBinary(@PathVariable("appId") long appId,
                                     @RequestParam(value = "threshold", defaultValue = "0.5") double threshold,
                                     @RequestParam(value = "avoidSameBinary") final boolean avoidSameBinary,
                                     @RequestParam(value = "topk", defaultValue = "15") int topk, //
                                     @RequestParam(value = "blk_min", defaultValue = "1") int blk_min, //
    ...
    @Access(AccessMode.READ)
    public final @ResponseBody
    Map<String, Object> searchBinaryDump(@PathVariable("appId") long appId,
    ...
    @Access(AccessMode.READ)
    public @ResponseBody
    Map<String, Object> searchBinaryRenderer(@PathVariable("appId") long appId,
    ...
    public final ModelAndView searchFunctionPage(@PathVariable("appId") long appId,
                                                 ...
                                                 @RequestParam(value = "func", defaultValue = "none") String func_queries,
                                                 @RequestParam(value = "topk", defaultValue = "15") int topk) {
        Map<String, Object> model = new HashMap<>();
        model.put("threshold", threshold);
        model.put("topk", topk);
        model.put("func", func_queries);
    ...
    @Access(AccessMode.READ)
    public final @ResponseBody
    Map<String, Object> searchFunctionRest(@PathVariable("appId") long appId,
                                           @RequestParam(value = "threshold", defaultValue = "-1") double threshold,
                                           @RequestParam(value = "topk", defaultValue = "15") int topk, //
        ...
        try {
            ...
            try {
                // try ghidra
                ObjectMapper mapper = new ObjectMapper();
                binary = mapper.readValue(
                        str, DisassemblyFactoryGhidraModel.class).toBinarySurrogate().processRawBinarySurrogate().toBinary();
            } catch (Exception e_ghidra) {
                e_ghidra.printStackTrace();
                // treat as raw text:

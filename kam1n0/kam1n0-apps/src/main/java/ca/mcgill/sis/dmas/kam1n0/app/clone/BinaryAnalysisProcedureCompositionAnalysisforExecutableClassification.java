...
public class BinaryAnalysisProcedureCompositionAnalysisforExecutableClassification extends LocalDmasJobProcedure {
	...
	public void runProcedure(long appId, String appType, ApplicationResources res, String userName,
		...
		BinarySearchUnitForClassification unit = null;
		try {

...
public class Asm2VecApplicationMeta extends ApplicationMeta {
	
	@Component
	public static class Wrapper {
		private static Asm2VecApplicationMeta meta;

		@Autowired
		public Wrapper(Asm2VecApplicationMeta meta_ins) {
			meta = meta_ins;
		}

		public static Asm2VecApplicationMeta getMeta() {
			return meta;
		}

	}

	public final static String appType = "/asm2vec-clone";
	public final static String modelName = "/asm2vec.bin";
	...
	private static Logger logger = LoggerFactory.getLogger(Asm2VecApplicationMeta.class);
	...
	@Autowired
	public Asm2VecApplicationMeta(AppPlatform platform, AppController controller, GlobalResources res) {
	...
	public <T extends ApplicationResources> T getResource(long appId) {
		...
		Asm2VecApplicationConfiguration conf = (Asm2VecApplicationConfiguration) info.configuration;
	...
	public void saveMode(long appId, Asm2VecCloneDetectorIntegration model) {
		try {
